  ...
  steps: [
    {
      ...
      instructions: [
        ...
        "Every worker instruction MUST require that each assertion exercise",
        "the imported module under test. Forbid tautologies, constant-to-constant",
        "assertions, assert(true), and assertions that would pass for any",
        "implementation. Require normal cases, edge/boundary cases, and a real",
        "test command run. Workers must not modify production source unless the",
        "original request explicitly asks them to do so.",
        "",
